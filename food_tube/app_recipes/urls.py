...
from app_recipes.views import Index, DishesByCategory, DishesList, DishesDetail, CategoryList, RecipesAdd, DishDel
...
urlpatterns = [
    ...
    path('dishes_info/<int:pk>/del/', DishDel.as_view(), name='del_dish'),
]
